...
public class UserServiceTest {
	...
	@Test
	public void shouldInitializeWithEightDemoUsers() {
		// act
		userService.initialize();
		// assert
		verify(accountRepositoryMock, times(8)).save(any(Account.class));
	}
	...
	public void shouldReturnUserDetails() {
		// arrange
		Account demoUser = new Account("user@example.com", "demo", "ROLE_USER", true);
